...
1. Open your CMD.
2. then type ``git clone https://github.com/LazaroDamasceno/Reactive-Car-Dealership-API.git``.
...
To watch the API running, watch the video on the link https://youtu.be/NGtTqjoV1tU
